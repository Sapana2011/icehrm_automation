...
import com.icehrm_automation.login.EmployeePage;
...
public class EmployeeTest extends BaseClass{
			...
			@Test
			public void verifySearchEmp()  {
				click(employeePage.employeeMenu);
				click(employeePage.employeeSubMenu);
				waitElementIsClickable(employeePage.searchButton);
				List<String> allEmpFNames = new ArrayList<String>();
